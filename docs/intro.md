...
---
## resume
https://www.cake.me/eagle-chen-c7849a


## side project
- [Woding(致敬inline的餐廳訂位網站)](https://github.com/5xruby-WoDing/WoDing)
- [CRM 廣告發票成本稽核自動化與流程重構](https://app.eraser.io/workspace/DDxgMejE0xRlniMNoGWd)  
  - 痛點解決： 針對過去依賴人工核對、數據分散導致核銷週期過長的問題進行優化。
  - 技術價值：身為 RD 核心開發者，重構發票稽核流程，使核銷週期從 21 天縮減至 3 天。
  - 溝通價值：成功協調 RD、Marketing 與 Accounting 三方需求，解決長期以來數據不一致與核對繁瑣之問題。
- [跨國電商產品價格自動化轉換與同步系統](https://script.google.com/home/projects/1cS4dWtGQvaRKPulO7RTQFkeBtl4QDnOW_VVvBLYWV6uidJaL1QvSUtG0/edit?hl=zh-tw)
  - 架構設計：建構 Serverless 數據中繼站，解決 Apps Script 無法處理跨來源資源共用 (CORS) 的限制。
  - 數據自動化：整合政府 Open Data API，實現匯率數據每日自動更新至雲端資料庫，確保價格轉換之即時性。
  - 解決痛點：克服前端抓取工具無法直接進行幣值計算與存庫的斷點，實現 100% 自動化數據流。

## 個人介紹

原本是一個數位行銷人員，但是在串接數據中串上癮了，決定實際踏入後端程式這個行業，我先去 astro camp 上補習班，了解後端寫程式到底是怎麼運作的。    
    
轉職成功後，進到廣告公司當 RD，主要工作是維護既有API、爬蟲，除此之外就是完成廣告部門提出的客製化程式需求，像是 "CRM 廣告發票成本稽核自動化與流程重構" 和 "跨國電商產品價格自動化轉換與同步系統"。
...
拿到 offer 之後，進入一家廣告公司的 RD 部門，負責處理一些資料庫的問題，並且在 11 月左右，決定去報名英文補習班，想想自己的英文真的是太爛了，如果以後要更上一層樓，一定要把英文給學好。

學完一年後 (2023~2024)，差不多 10 月去考試，多益分數從 3, 400 進步到 800，並且終於可以順利的聽懂一些英文程式介紹的相關頻道，接下來，我又繼續報名了 IELTS 雅思的課程，因為我決定未來要往國外來試試，看我之後可不可以跳脫目前的舒適圈，前往外國工作


### 又過了一年 - 2026/03/05

上了一年的雅思課程 (2024~2025)，英文程度覺得非常夠用了，跟外國老師講話基本上沒有太大的問題。    
之後考了一次 IELTS 考試，平均分數為 5.5，可惜口說爆炸了，只有拿到 5.0，要不然可以拿到 6 的，要不然會直接考慮去澳洲唸書。    

在 2026 決定去澳洲打工一年試試，前三個月去語言學校，後面的時間在澳洲打工度假，這兩年 AI 的進化速度實在太快，還真的不知道以後 junior 工程師還會不會有太多的機會，因此去澳洲換個環境體驗生活一下。

而且我還希望澳洲回來後，也能去加拿大一年看看，在 35 歲之前多去幾個國家，要不然老了在出國，感覺就差很多
